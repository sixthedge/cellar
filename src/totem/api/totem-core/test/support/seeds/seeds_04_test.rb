...
describe '04: seeds.rb' do

  before do 
    set_environment
    register_seed_engines
    load_platform_configs(file: __FILE__, file_ext: '04_*', clear_engines: false)
    register_framework_and_platform
    @seed = @env.seed
  end

  it '04: seed order is from seed order section' do 
  ...
  it '04: seed order for framework' do
    expect = [
      'test_framework_core',
      'test_framework_seed_one',
      'test_framework_seed_two',
  ...
  it '04: seed order for platform' do
    expect = [
      'test_platform_seed_one',
      'test_platform_seed_two',
      'test_platform_seed_zero',
