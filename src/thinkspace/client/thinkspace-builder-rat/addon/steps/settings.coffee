...
export default step.extend changeset_helpers,
  ...
  create_changesets: ->
    ...
    changesets.pushObject @set('trat_scoring_cs', trat_scoring_cs)
    changesets.pushObject @set('changeset', changeset)
    changesets.pushObject @set('irat_changeset', irat_changeset)
    changesets.pushObject @set('trat_changeset', trat_changeset)
    changesets.pushObject @set('scoring_changeset', scoring_changeset)
